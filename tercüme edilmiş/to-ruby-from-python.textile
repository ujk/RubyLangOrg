...
Pythondan ruby'e geçerken, ruby de pythona göre öğrenmeniz gereken daha fazla söz dizimi bulabilirsiniz.
...
* Bazı zorunlu harf kuralları vardır. (ör. sınıf isimleri
büyük harfle başlar, değişkenler küçük harfle başlar).
...
özel "ifade ikame" söz dizilerine (Ruby ifadelerinin sonuçlarını diğer karakter dizelerine
@"add " + "strings " + "together"@ şeklinde uğraşmadan direkt olarak eklemenizi sağlar) izin verir. Tek tırnaklı karakter dizeleri Python'ın @r"ham karakter dizeleri"@ gibidir.
...
* Erişim izinleri için Python'ın @_voluntary_@ underscore@__convention__@ ifadeleri yerine @public@, @private@ ve @protected@ ifadeleri vardır.
...
* Doğruluk test edildiğinde, sadece @false@ ve @nil@ false bir değer döner.
Diğer her şey true döner (@0@, @0.0@, @""@, ve @[]@ dahil).
